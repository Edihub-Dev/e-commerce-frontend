      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="flex w-full max-w-xl flex-col rounded-2xl bg-white p-6 shadow-xl md:my-0 max-h-[calc(100vh-4rem)] overflow-hidden"
          >
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <label className="flex flex-col gap-1 text-xs font-medium text-slate-500">
                    ...
                    <input
                      ...
                      placeholder={
                        isStockLocked ? "Managed automatically" : "40"
                      }
                    />
                    {isStockLocked && (
                      <span className="text-[11px] text-slate-500">
